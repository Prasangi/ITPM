...
Route::get('/course', 'mycontroolercourse@index');

Route::get('/IT1styearsemester', function () {
    return view('IT1styearsemester');
});

Route::get('/IT2styearsemester', function () {
    return view('IT2styearsemester');
});

Route::get('/IT1styear1semcsdetails', function () {
    return view('IT1styear1semcsdetails');
});
